...
**实现指令的默认附带链接**：`docs/v10/V11_PROGRAMMER_AI_OPERATING_RULES_20251227.md`

**实现前必读（只看这 3 个）**
- `docs/v10/V11_BASELINE_CHANGELOG_20251226.md`
- `docs/v10/V11_DESIGN_EXECUTION_WORLD_20251227.md`
- `docs/v10/V11_EXECUTION_WORLD_CLOSURE_ALLOWLIST_20251227.md`
