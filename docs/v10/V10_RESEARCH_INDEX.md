...
- **V11 Step 37（paging query_chain_id/scope_id：防混链）**：
  ...
  - Record（Quant 落地）：`docs/v10/V11_STEP37_PAGING_QUERY_CHAIN_ID_IMPLEMENTED_IN_QUANT_20251229.md`
- **V11 Step 38（run_manifest 冻结 audit scope anchors）**：
  - Spec：`docs/v10/V11_STEP38_AUDIT_SCOPE_ANCHORS_IN_MANIFEST_20251229.md`
...
- **V11 Step 41（审计链 evidence_refs 统一协议）**：
  ...
  - Record（Quant 落地）：`docs/v10/V11_STEP41_EVIDENCE_REFS_STANDARD_IMPLEMENTED_IN_QUANT_20251229.md`
- **V11 Step 42（审计链 evidence_refs 强约束升级）**：
  - Spec：`docs/v10/V11_STEP42_EVIDENCE_REFS_HARDENING_20251229.md`
...
- **V11 Step 44（evidence_refs 可解引用校验）**：
  ...
  - Record（Quant 落地）：`docs/v10/V11_STEP44_EVIDENCE_REFS_DEREFERENCE_VALIDATION_IMPLEMENTED_IN_QUANT_20251229.md`
...
- **V11 Step 51（最小对照实验跑通 + ablation_summary.json）**：
  ...
  - Record（Quant 落地）：`docs/v10/V11_STEP51_MIN_ABLATION_RUN_AND_SUMMARY_IMPLEMENTED_IN_QUANT_20251230.md`
