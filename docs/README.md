# Docs Index (English) / 文档索引（中文）

## What is this? / 这是什么？

**English (primary)**: `docs/` is the curated documentation set for Prometheus-Research.  
If you are here to **audit V10** or **reproduce conclusions**, start with the V10 index.

**中文（辅助）**：`docs/` 是 Research 仓库的“整理后文档”。如果你要复核 V10 结论，请从 v10 证据链入口开始。
...
- **V12 Index / V12入口**: `docs/v12/V12_RESEARCH_INDEX.md`
...
- **`docs/v12/`**: V12 world modeling + life system track (SSOT index + new docs)
...
- **`docs/v8/`, `docs/v7/`, `docs/v6/`**: legacy versions
