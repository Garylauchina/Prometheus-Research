...
- Gate4 增补：
  ...
  - Step 53：跨 run 对照聚合报告：生成 `ablation_compare.json`（读取两份 `ablation_summary.json`，做可比性检查 + 事实差异统计 + evidence_refs 可复核）（规格见：`docs/v11/V11_STEP53_ABLATION_COMPARE_REPORT_20251230.md`）。
