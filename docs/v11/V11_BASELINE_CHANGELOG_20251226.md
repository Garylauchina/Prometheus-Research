...
- Gate4 增补：
  ...
  - Step 56：把 Step55 验收升级为 CI 必跑 gate（Quant CI 必须运行 `tools/test_step54_integration.py` 并 PASS），防止后续回归破坏 Step53/54 的证据闭环（规格见：`docs/v11/V11_STEP56_CI_GATE_STEP55_ACCEPTANCE_20251230.md`）。
