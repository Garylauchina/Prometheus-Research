# Prometheus v3.1 迁移指南

## 📋 概述

本文档帮助您从旧的项目结构迁移到新的v3.1重构版本。
...
| 版本 | 日期 | 主要变化 |
|------|------|----------|
| v3.1 | 2025-12-02 | 完整重构，模块化架构，Evolution系统 |
| v3.0 | 2025-11-29 | 基础版本，OKX集成 |
...
| 版本 | 预计时间 | 主要功能 |
|------|----------|----------|
| v3.2 | 2025-12 | 动态止损/止盈，Web监控面板 |
| v3.3 | 2026-Q1 | 机器学习集成，跨交易所套利 |
