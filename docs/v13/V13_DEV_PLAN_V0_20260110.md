...
Operational constraint (accepted as world condition):
- If the local environment cannot use WebSocket, Phase 1 must run on a VPS.
- Treat “needs VPS to observe” as an observation condition, not as an engineering defect.
